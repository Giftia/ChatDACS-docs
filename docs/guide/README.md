...
```json
{
  "画师算命插件": {
    "使用例": "画师算命",
    "小夜返回": "你是一个迪士尼风格画师，最喜欢画美少女，而且找不到工作，然而因为画得太过和谐而被举报，还因为这件事在微博上有了50796个粉丝，做了49年画师，最后成为 了魔法少女。",
    "功能描述": "avg小说模板，由一段段随机语料拼凑成一段完整的小故事，可以参考示例写法自由扩展，写简单的随机小故事。",
    "详情": "作者 Giftina, 版本 2.0"
  },
  "敷衍语料教学插件": {
    "使用例": "说不出话 ？",
    "小 夜返回": "哇！小夜学会啦！小夜可能在说不出话的时候说 ？ 噢",
    "功能描述": "balabala敷衍教学，教给小夜一些比较通用的回复。对于一些难以回复的对话，小夜的词库中没有搜索到回复的时候，小夜会随机回复这些回复作为敷衍，回复了，但完全没有回复的意义。",
    "详情": "作者 Giftina, 版本 2.0"
  },
  "微信息知频道消息推送插件": {
    "使用例": "提醒我晚上要手冲",
    "小夜返回": "好的，我会提醒你晚上要手冲",
    "功能描述": "将指定格式的消息推送至微信息知指定频道，适合传送消息至微信。",
    "详情": "作者 Giftina, 版本 2.2"
  },
  "聊天教学插件": {
    "使用例": "问：HELLO 答：WORLD",
    "小夜返回": "哇!小夜学会啦!对我说: HELLO 试试吧，小夜有可能会回复 WORLD 噢",
    "功能描述": "添加一组新的聊天回复，抄板于虹原翼版小夜v3教学系统。来调教小夜说话吧！在优秀的聊天算法加成下，帮助养成由数万用户调教练就的嘴臭词库。当小夜收到含有 `关键词` 的语句时便会有几率触发回复。若该关键词有多个回复，将会随机选择 一个回复。支持图片问答。注意！冒号是中文全角的 `：`，而不是英文半角的 `:`，并且在 `关键词` 和 `答：` 之间有一个空格。注意注意！如果像这样 `问：小夜的主人到底是谁呀 答：是你呀` 直接教完整的一句话的话是很难有 效触发的，这就很考验你应该如何选择关键词了。像上面那个例子，更好的教学是： `问：主人 答：是你呀`",
    "详情": "作者 Giftina, 版本 2.1"
  },
  "cos图片插件": {
    "使用例": "cos图",
    "小夜返回": "[一张cos图]",
    "功能描述": "在普通 限度的尺度下发送一张合法的 cos 三次元图, 图片来源哔哩哔哩cos专栏。",
    "详情": "作者 Giftina, 版本 2.0"
  },
  "cp文生成插件": {
    "使用例": "cp 小夜 小雫",
    "小夜返回": "小夜，小雫，你们的爱情是什么样子？",
    "功能描述": "cp文生成器，生成一段简单的 cp 文。简简单单，就是最好的爱。语料来自 https://github.com/mxhcpstories/mxh-cp-stories/blob/master/src/assets/story.json",
    "详情": "作者 Giftina, 版本 2.0"
  },
  "赛博百科问答插件": {
    "使用例": " 赛博朋克",
    "小夜返回": "大明湖畔位于哪个城市？ 请按如下格式回答: 赛博朋克 你的答案",
    "功能描述": "非常赛博朋克的百科知识问答题",
    "详情": "作者 Giftina, 版本 2.0"
  },
  "名场面插件": {
    "使用例": "名场面 不能逃避",
    "小夜返回": "原作：福音战士新剧场版：序 不能逃避…不能逃避…不能逃避… 不能逃避…不能逃避…不能逃避… 不能逃避",
    "功能描述": "根据字幕台词搜索名场面出处，原作：https://github.com/windrises/dialogue.moe",
    "详情": "作者 Giftina, 版本 1.1"
  },
  "报错插件": {
    "使用例": "报错 插件爆炸了",
    "小夜返回": "谢谢您的报错，小夜已经把您的报错信息 插件爆炸了 发给了小夜开发群120243247啦",
    "功能描述": "向小夜开发组报错消息，消息会实时转达到小夜开发成员",
    "详 情": "作者 Giftina, 版本 2.0"
  },
  "最新本子插件": {
    "使用例": "最新本子",
    "小夜返回": "[返回仓库的随机最新投稿]",
    "功能描述": "从 https://cangku.icu/feed 获取最新投稿",
    "详情": "作者 Giftina, 版本 1.0"
  },
  "黑白生草图生成器插件": {
    "使用例": "黑白图 当你凝望神圣手雷的时候，神圣手雷也在凝望你 あなたが神圣手雷を見つめるとき、神圣手雷もあなたを見つめています[图片]",
    "小夜返回": "[一张黑白生草图]",
    "功能描述": "生成一张黑白生草图。",
    "详 情": "作者 Giftina, 版本 2.1"
  },
  "帮助插件": {
    "使用例": "/help",
    "小夜返回": "当前插件列表和使用示例：",
    "功能描述": "会回复系统当前可用插件列表，描述插件版本和对应的使用示例。",
    "详情": "作者 Giftina, 版本 2.1"
  },
  "人生重开模拟器插件": {
    "使用例": "人生重开",
    "小夜返回": "[人生重开的结果]",
    "功能描述": "一个人生重开模拟器，区别于原作，该版本非常真实。原作 https://github.com/VickScarlet/lifeRestart",
    "详情": "作者 Giftina, 版本 1.0"
  },
  "今日不带套插件": {
    "使用例": "今天不带套",
    "小夜返回": "小夜温馨提示您: 今日不戴套，小小夜酱 金牛座，属兔，2041年高考，一本机率约43%",
    "功能描述": "2018年七夕节彩蛋功能，让小夜帮你计算今天不带套的结果，仅供娱乐 。",
    "详情": "作者 Giftina, 版本 2.0"
  },
  "猫语翻译器插件": {
    "使用例": "喵嗷嗷嗷嗷呜~嗷呜喵嗷喵嗷嗷~嗷嗷嗷~",
    "小夜返回": "喵~",
    "功能描述": "可以将文本加密为 `喵嗷呜` 格式的喵语，也可将喵语解密成原始文本。解密不需要猫语前缀，直接原样发送即可。原作 https://github.com/ezshine/chrome-extension-catroom",
    "详情": "作者 Giftina, 版本 2.0"
  },
  "连通性测试插件": {
    "使用例": "/ping",
    "小夜返回": "Pong!",
    "功能描述": "PingPong，最基础的响应插件，可基于本插件学习插件的开发。该插件实现了一个可以测试小夜的连通性的功能。",
    "详情": "作者 Giftina, 版本 2.0"
  },
  "迫害生草图生成器插件": {
    "使用例": "/迫害 上原步梦 是我，是我先，明明都是我先来的……接吻也好，拥抱 也好，还是喜欢上那家伙也好。",
    "小夜返回": "[一张迫害生草图]",
    "功能描述": "让小夜来制作缺德的迫害表情包吧。现在可以迫害的对象：唐可可, 上原步梦, 猛男狗, 令和, 鸭鸭, 陈睿",
    "详情": "作者 Giftina, 版本 2.1"
  },
  "prpr 插件": {
    "使用例": "/prpr 嘉然",
    "小夜返回": "小夜 舔了舔 嘉然 的 小嘴，我好兴奋啊!",
    "功能描述": "让小夜帮你舔 ta 吧。来自 jjbot 的功能",
    "详情": "作者 Giftina, 版本 2.0"
  },
  "二维码生成插件": {
    "使用例": "/qr 114514",
    "小夜返回": "[代表114514含义的二维码]",
    "功能描述": "快速生成一个二维码，使用sumt的api。",
    "详情": "作者 Giftina, 版本 2.0"
  },
  "r18色图插件": {
    "使用例": "可以色色",
    "小夜返回": "[一张r18图]",
    "功能描述": "在危险的尺度下发送一张非法的 r18 二次元色图，图片来源api.lolicon.app。",
    "详情": "作者 Giftina, 版本 2.0"
  },
  "随机二次元图插件": {
    "使用例": "二次元",
  ...
  "本地随机图插件": {
    "使用例": "让我康康",
    "小夜返回": "[一张本地的随机图]",
    "功能描述": "从本地图片文件夹随机发送图片，默认使用其他插件自动下载保存的图库文件夹.",
    "详情": "作者 Giftina, 版本 2.0"
  },
  "随机网图插件": {
    "使用例": "随机网图",
    "小夜返回": "[一张随机网图]",
    "功能描述": "从随机网络图源下载图片后发送图片，图源可以自定义，网上很多。",
    "详情": "作者 Giftina, 版本 2.1"
  },
  "复读机插件": {
    "使用例": "[某条 消息重复了2次]",
    "小夜返回": "[小夜复读了这条消息]",
    "功能描述": "特殊插件，没有主动触发指令。当某条消息重复 2 次时，\\'小夜牌高保真复读机\\' 会跟风复读一次。",
    "详情": "作者 Giftina, 版本 2.1"
  },
  "roll插件": {
    "使用例": "/roll",
    "小夜返回": "你roll出了114514",
    "功能描述": "随机 roll 出 0 到 1000000 的随机数，可以自行跟随参数。",
    "详情": "作者 Giftina, 版本 2.0"
  },
  "搜图插件": {
    "使用例": "来点好的白丝",
    "小夜返回": "[一张健全的白丝图]",
    "功能描述": "搜索一张指定tag的二次元图。`好的` 代表正常尺度，`坏的` 代表🈲。图片来源api.lolicon.app。",
    "详情": "作者 Giftina, 版本 2.0"
  },
  "系统配置查询插件": {
    "使用例": "系统状态",
    "小夜返回": "[小夜的相关信息与系统当前的主要配置项]",
    "功能描述": "查询小夜的相关信息与系统当前的主要配置项",
    "详情": "作者 Giftina, 版本 2.1"
  },
  "淘宝买家秀色图插件": {
    "使用例": "买家秀",
    "小夜返回": "[一张买家秀图]",
    "功能描述": "在危险的尺度下发送 一张非法的淘宝买家秀福利图。",
    "详情": "作者 Giftina, 版本 2.0"
  },
  "状态栏提示插件": {
    "使用例": "弹窗 您可能是盗版软件的受害者",
    "小夜返回": "[在宿主电脑弹出一个消息通知：\\'您可能是盗版软件的受害者\\']",
    "功能描述": " 自动在任务栏显示一个常驻托盘，仅在Windows系统下有效。弹窗指令会在小夜宿主电脑上弹出一条消息通知。",
    "详情": "作者 Giftina, 版本 2.1"
  },
  "语音合成插件": {
    "使用例": "/吠 太好听了吧啊，你唱歌真的好嗷好听啊，简直就是 天岸籁，我刚才听到你唱歌了，我们以后一起唱好不好，一起唱昂，一起做学园偶像昂",
    "小夜返回": "[唐可可中文语音]",
    "功能描述": "让小夜开口说话吧。小夜使用基于大数据的情感幼女语音合成技术，能吠出更自然的发音、更丰富 的情感和更强大的表现力。可以插入一些棒读音以提高生草效果。",
    "详情": "作者 Giftina, 版本 2.1"
  }
}
```
